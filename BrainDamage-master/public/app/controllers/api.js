...
module.exports=function(router){
    ...
    //find if there is username password and email entred or they are empty
        ...
        } if((req.body.firstanswer||req.body.secondanswer||req.body.thirdanswer)===req.body.correctanswer)
        { res.json({success:false,message:"No correct answer has been added"});
        } 
            else {
